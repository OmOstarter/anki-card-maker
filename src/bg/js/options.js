...
async function populateAnkiFields(options) {
    ...
    let fields = ['expression', 'reading', 'extrainfo', 'definitions', 'sentence', 'url', 'audio'];
...
function populateSysScriptsList(dictLibrary) {
    ...
    let systemscripts = [
        'builtin_encn_WordnetKaikki', 'builtin_encn_Collins', 'general_Makenotes',//default & builtin script
        'cncn_Zdic', //cn-cn dictionary
        'encn_Collins', 'encn_Collins_tc', 'encn_Cambridge', 'encn_Cambridge_tc', 'encn_Oxford', 'encn_Youdao', 'encn_Baicizhan', //en-cn dictionaries
...
async function onSaveClicked(e) {
    ...
    let fields = ['deckname', 'typename', 'expression', 'reading', 'extrainfo', 'definitions', 'sentence', 'url', 'audio'];
    fields.forEach(field => {
