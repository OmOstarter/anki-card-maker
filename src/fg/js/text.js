...
function isValidElement(node = null) {
    const candidates = [node, getDeepActiveElement(document), getSelectionContainer()].filter(Boolean);
...
function isEditableElement(node) {
    ...
    return Boolean(element.closest('input, textarea, [contenteditable]:not([contenteditable="false"]), [role="textbox"]'));
}
